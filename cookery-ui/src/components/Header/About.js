...
const About = () => (
  <div className="about-root">
    ...
    <p className="welcome--about">
      ...
      Food is essential in life so there are many ways to create content that caters to the subject. 
      With everything from the latest recipe and concoction to even the best places to eat, in a city you recently visited--the possibilities of producing write-ups that accommodate foodies all over the world are endless.
